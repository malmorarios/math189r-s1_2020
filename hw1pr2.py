"""
Start file for hw1pr2 of Big Data Summer 2020
...
if __name__ == '__main__':
	...
	# TODO: replace the m_opt and b_opt with the solution you obtained from (DONE.) #
	...
	X_space = np.linspace(-1,10,100).reshape(-1, 1)
	...
	y_pred_rand = np.array([m_rand_opt * x + b_rand_opt 
		for x in X_space]).reshape(-1, 1)
	"*** YOUR CODE HERE ***"
